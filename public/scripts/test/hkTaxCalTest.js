...
suite('hkTaxCal', function() {
  ...
  test('calculate tax on NetChargeable Income', function() {
    ...
    assert.equal(hkTaxCal.calProgressive(40000, 'y2014'), 800);
    assert.equal(hkTaxCal.calProgressive(80000, 'y2014'), 3600);
    assert.equal(hkTaxCal.calProgressive(120000, 'y2014'), 8400);
    assert.equal(hkTaxCal.calProgressive(1234567, 'y2014'), 197876);

    //Form IRD Allowances and tax rate table
    assert.equal(hkTaxCal.calProgressive(120000, 'y2014'), 8400);


    assert.equal(hkTaxCal.calProgressive(40000, 'y2015'), 800);
    assert.equal(hkTaxCal.calProgressive(80000, 'y2015'), 3600);
    assert.equal(hkTaxCal.calProgressive(120000, 'y2015'), 8400);
    assert.equal(hkTaxCal.calProgressive(1234567, 'y2015'), 197876);
  ...
  test('calculate tax both methods', function() {
    // assert.equal(hkTaxCal.calculateTax(12345678, 1000, 120000, 'y2013'),
    //   1851702); //web page is 1851701

    assert.equal(hkTaxCal.calculateTax('y2014', 12345678, 1000, 120000),
      1851702); //web page is 1851701

    assert.equal(hkTaxCal.calculateTax('y2015', 12345678, 1000, 120000),
      1851702); //web page is 1851701
